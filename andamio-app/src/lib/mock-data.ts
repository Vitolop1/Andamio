...
export const courses: Course[] = [
  {
    id: "course-taller-fono",
    institutionId: "inst-andamio",
    name: "Taller de fonoaudiologia",
    schoolYear: "2026",
    level: "Seccion",
    shift: "Mixto",
    teacher: "Lic. Emilia Maidana",
    studentCount: 1,
    subjects: ["Fonoaudiologia", "Lenguaje", "Articulacion"],
  },
  {
    id: "course-verano-intensivo",
    institutionId: "inst-andamio",
    name: "Curso de verano intensivo",
    schoolYear: "2026",
    level: "Intensivo",
    shift: "Verano",
    teacher: "Lic. Emilia Maidana",
    studentCount: 0,
    subjects: ["Refuerzo escolar", "Rutinas", "Habitos"],
  },
  {
    id: "course-taller-lecto",
    institutionId: "inst-andamio",
    name: "Taller de lectoescritura",
    schoolYear: "2026",
    level: "Seccion",
    shift: "Tarde",
...
export const students: Student[] = [
  {
    ...
    portalEmail: "juana.r444444@andamiosaltas.com",
  ...
  },
  {
    ...
    pendingTasks: 0,
    assignedProfessionalIds: ["11111111-1111-1111-1111-111111111112"],
    portalEmail: "mateo.c444444@andamiosaltas.com",
  ...
  },
  {
    ...
    portalEmail: "pilar.s444444@andamiosaltas.com",
  ...
  },
  {
    ...
    portalEmail: "santino.d444444@andamiosaltas.com",
...
export const scheduleEvents: ScheduleEvent[] = [
  ...
  {
    id: "event-2",
    title: "Revision con docente 5to grado",
    date: "2026-03-12",
    startTime: "16:15",
    endTime: "16:45",
    professionalId: "11111111-1111-1111-1111-111111111112",
  ...
  {
    id: "event-3",
    title: "Sesion grupal - Taller de fonoaudiologia",
    date: "2026-03-14",
    startTime: "10:00",
    endTime: "11:00",
...
export const uploadWizardSteps = [
  ...
  },
  {
    ...
    description:
      "Asignar institucion, grado, seccion y alumno para evitar archivos sueltos o duplicados.",
  },
  {
    step: "Paso 3",
